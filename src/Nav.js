                ...
                <nav className="navbar is-primary" aria-label="main navigation">
                    ...
                    <div className="navbar-menu">
                        ...
                        <div className="navbar-end">
                            <div className="navbar-item">
                                <div className="buttons">
                                    <Popup trigger={<button className="button is-link" >Export</button>} modal closeOnDocumentClick onOpen={this.handleExportClick}>
                                        <div className="box" id="popbox"><pre>{this.state.journey}</pre></div>
                                    </Popup>
                                </div>
                            </div>
                        </div>
